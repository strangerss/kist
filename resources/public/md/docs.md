...
Two middleware functions are provided by default in the `kist.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `kist.handler` namespace to manage the enabled middleware.
